...
import { ArrowLeft, Linkedin, Github, Calendar, BarChart3 } from "lucide-react";
      ...
      <div className="container mx-auto max-w-7xl px-6">
        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <div className="flex gap-3 mt-10 opacity-0 animate-fade-up stagger-5">
            ...
            {member.twitter && (
              <a href={member.twitter} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full glass border border-white/10 flex items-center justify-center hover:border-emerald-500/50 hover:bg-emerald-500/10 transition-all hover:scale-110 group">
            ...
            {member.github && (
              <a href={member.github} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full glass border border-white/10 flex items-center justify-center hover:border-teal-500/50 hover:bg-teal-500/10 transition-all hover:scale-110 group">
