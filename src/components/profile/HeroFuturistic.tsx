...
import { ArrowLeft, Linkedin, Github, Calendar, Brain } from "lucide-react";
    ...
    <section className="min-h-screen flex items-center relative pt-20 overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl px-6">
        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          {/* Badge */}
          <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full glass border border-pink-500/30 w-fit mb-6 opacity-0 animate-fade-up stagger-1">
          ...
          <div className="flex gap-3 mt-10 opacity-0 animate-fade-up stagger-5">
            {member.linkedin && (
              <a href={member.linkedin} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full glass border border-white/10 flex items-center justify-center hover:border-pink-500/50 hover:bg-pink-500/10 transition-all hover:scale-110 group">
                <Linkedin className="w-5 h-5 group-hover:text-pink-400 transition-colors" />
              </a>
            )}
            {member.twitter && (
              <a href={member.twitter} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full glass border border-white/10 flex items-center justify-center hover:border-rose-500/50 hover:bg-rose-500/10 transition-all hover:scale-110 group">
