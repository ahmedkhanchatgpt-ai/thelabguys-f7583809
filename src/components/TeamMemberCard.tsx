...
const TeamMemberCard = ({ member, index, variant = "default" }: TeamMemberCardProps) => {
  ...
  return (
    ...
    >
      ...
      <div className={`absolute inset-0 bg-gradient-to-br ${member.gradient} opacity-0 group-hover:opacity-15 transition-opacity duration-300`} />
      ...
      <div className={`relative p-3 sm:p-4 md:p-5 lg:p-6 flex flex-col h-[180px] sm:h-[220px] md:h-[280px] lg:h-[300px] xl:h-[320px]`}>
        ...
        <div className="flex-1 flex items-center justify-center relative">
          ...
          <div className={`absolute w-16 sm:w-20 md:w-28 lg:w-32 h-16 sm:h-20 md:h-28 lg:h-32 ${member.iconBg} rounded-full blur-2xl md:blur-3xl opacity-20 group-hover:opacity-40 transition-opacity duration-300`} />
          
          {/* Main orb */}
          <div className={`relative w-14 h-14 sm:w-18 sm:h-18 md:w-24 md:h-24 lg:w-28 lg:h-28 xl:w-32 xl:h-32 rounded-full ${member.iconBg} flex items-center justify-center text-white text-base sm:text-xl md:text-2xl lg:text-3xl font-display font-bold shadow-lg group-hover:scale-105 transition-transform duration-300`}>
        ...
        <div className="relative mt-auto pt-2 md:pt-3 lg:pt-4 flex items-end justify-between gap-1.5 sm:gap-2">
          ...
          {/* Arrow button */}
          <div className={`flex-shrink-0 w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 lg:w-10 lg:h-10 rounded-full ${member.iconBg} flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
