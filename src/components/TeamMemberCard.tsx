  ...
  return (
    ...
    >
      ...
      <div className={`relative p-6 flex flex-col h-[320px]`}>
        ...
        <div className="relative mt-auto pt-4 flex items-end justify-between gap-2">
          <div className="flex-1 min-w-0">
            <h3 className="font-display text-base md:text-lg font-semibold text-foreground mb-1 group-hover:text-gradient transition-all duration-300 leading-tight">
              {member.name}
            </h3>
          ...
          <div className={`flex-shrink-0 w-8 h-8 md:w-10 md:h-10 rounded-full ${member.iconBg} flex items-center justify-center group-hover:scale-110 transition-all duration-300 shadow-lg`}>
