...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    shortBio: "Driving brand growth through strategic marketing campaigns.",
    fullBio: "I'm a marketing specialist focused on building brand awareness and driving customer engagement. From crafting compelling campaigns to analyzing market trends, I help businesses connect with their target audience effectively. My approach combines creativity with data-driven strategies to maximize ROI and build lasting brand relationships.",
    skills: ["Digital Marketing", "Social Media", "Content Marketing", "Brand Strategy", "Campaign Management", "Analytics"],
