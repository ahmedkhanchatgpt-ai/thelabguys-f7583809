...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    tagline: "Transforming visions into cinematic masterpieces",
    shortBio: "Award-winning video editor crafting viral content for global brands.",
    layoutVariant: "creative",
    fullBio: "I'm a senior video editor and motion designer with 5+ years of experience creating high-impact visual content for brands, influencers, and agencies worldwide. My work has generated over 10M+ views across platforms. I specialize in cinematic storytelling, dynamic motion graphics, and scroll-stopping social media content. From concept to color grade, I deliver broadcast-quality results with fast turnarounds.",
    skills: ["Premiere Pro", "After Effects", "DaVinci Resolve", "Cinema 4D", "Motion Graphics", "Color Grading", "Sound Design", "Storyboarding"],
    services: [
      { title: "Cinematic Video Editing", description: "Professional editing with color grading, sound design & VFX for films, ads & documentaries" },
      { title: "Motion Graphics & Animation", description: "Eye-catching 2D/3D animations, logo reveals, intros & explainer videos" },
      { title: "Social Media Content", description: "Viral-ready short-form content optimized for TikTok, Reels & YouTube Shorts" },
      { title: "Brand Video Production", description: "End-to-end video production from storyboarding to final delivery" },
    ],
    process: [
      { step: 1, title: "Creative Brief", description: "Deep dive into your vision, brand voice & project goals" },
      { step: 2, title: "Storyboard & Concept", description: "Visual planning with mood boards & sequence breakdowns" },
      { step: 3, title: "Edit & Refine", description: "Precision editing with color, sound & motion graphics" },
      { step: 4, title: "Final Delivery", description: "Export in all formats with revisions until perfect" },
    ],
    stats: [
    ...
    glowColor: "shadow-[0_0_80px_-10px_hsl(280_100%_60%/0.6)]",
